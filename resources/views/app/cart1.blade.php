          ...
          <div class="content-main__container">
            <div class="cart-product-list">
              ...
              <div class="cart-product-list__item">
                <div class="cart-product__item__product-photo"><img src="../../../public/storage/{{$order->image}}" class="cart-product__item__product-photo__image"></div>
                <div class="cart-product__item__product-name">
                  <div class="cart-product__item__product-name__content"><a href="/public/product/{{$order->product_id}}">{{$order->product}}</a></div>
                </div>
