    ...
    <header class="main-header">
      ...
      <div class="header-container">
        ...
        @if (Route::has('login'))
            ...
            @endif
         <!-- <a href="/public/register" class="authorization-block__link">Регистрация</a>
          <a href="/public/login" class="authorization-block__link">Войти</a> -->
        </div>
      </div>
    </header>
    <div class="middle">
          ...
          <div class="content-main__container">
            ...
            @foreach ($products as $p)
              <div class="products-columns__item">
                <div class="products-columns__item__title-product"><a href="/public/product/{{$p->id}}" class="products-columns__item__title-product__link">{{$p->name}}</a></div>
                <div class="products-columns__item__thumbnail"><a href="/public/product/{{$p->id}}" class="products-columns__item__thumbnail__link"><img src="../../../public/storage/{{$p->image}}" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
                <div class="products-columns__item__description"><span class="products-price">{{$p->price}} руб</span><a href="/public/buy/{{$p->id}}" class="btn btn-blue">Купить</a></div>
              </div>
            @endforeach 
            </div>
          </div>
