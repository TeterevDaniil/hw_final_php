      ...
      <div class="middle">
        ...
        <div class="main-content">
          <div class="content-top">
            ...
            <div class="image-container"><img src="../../../resources/views/app/img/slider.png" alt="Image" class="image-main"></div>
          </div>
          <div class="content-middle">
            <div class="content-head__container">
              <div class="content-head__title-wrap">  
                <div class="content-head__title-wrap__title bcg-title">@foreach($prod as $p)
                                                        {{$p->name}} <br>
                                                      в разделе {{$p->category->name}}
                                                      @endforeach </div>
              </div>
            ...
            <div class="content-main__container">
              <div class="product-container">
                <div class="product-container__image-wrap"><img src="../../../public/storage/{{$p->image}}" class="image-wrap__image-product"></div>
                <div class="product-container__content-text">
                  <div class="product-container__content-text__title"> {{$p->name}}</div>
                  <div class="product-container__content-text__price">
                    <div class="product-container__content-text__price__value">
                      Цена: <b> {{$p->price}}</b>
                      руб
                    </div><a href="/public/buy/{{$p->id}}" class="btn btn-blue">Купить</a>
                  </div>
            ...
            <div class="content-main__container">
              <div class="products-columns">
                ...
                <div class="products-columns__item">
                  <div class="products-columns__item__title-product"><a href="/public/product/{{$product->id}}" class="products-columns__item__title-product__link">{{$product->name}}</a></div>
                  <div class="products-columns__item__thumbnail"><a href="/public/product/{{$product->id}}" class="products-columns__item__thumbnail__link"><img src="../../../public/storage/{{$product->image}}" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
                  <div class="products-columns__item__description"><span class="products-price">{{$product->price}} руб</span><a href="/public/buy/{{$product->id}}" class="btn btn-blue">Купить</a></div>
                </div>
                @endforeach
               </div>
            </div>
